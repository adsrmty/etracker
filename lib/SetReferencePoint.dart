...
class SetReferencePoint extends StatefulWidget {
  const SetReferencePoint({super.key, required this.title});
  ...
  @override
  State<SetReferencePoint> createState() => _SetReferencePointState();
}

class _SetReferencePointState extends State<SetReferencePoint> {
  ...
  List<DropdownMenuItem<String>> _dropDownCarItems = List<DropdownMenuItem<String>>.empty();
  String _selectedCar = "_selectedCar";
  ...
  String _getAssetName(String carName) {
    String assetName = 'assets/images/JeppOneColorNoStyle.svg';
